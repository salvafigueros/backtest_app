...
class Futures(Asset):
    ...
    def __init__(self, ticker, futures_name, currency):
        self.ticker = ticker
    ...
    def insert(futures):
        ...
        conn_cursor.execute("INSERT INTO futures(ticker, futures_name, currency) VALUES(%s, %s, %s)", (futures.ticker, futures.futures_name, futures.currency))
        futures.id = conn_cursor.lastrowid
        conn_bd.commit()
